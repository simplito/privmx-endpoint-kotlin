    ...
    namespace wrapper {
        ...
        jobject streamTrackInfo2Java(
            ...
            return ctx->NewObject(
                    ...
                    (jlong) streamTrackInfo_c.mindex,
