...
Java_com_simplito_kotlin_privmx_1endpoint_modules_inbox_InboxApi_closeFile(
    ...
    ctx.callResultEndpointApi<jstring>(
            ...
            [&ctx, &thiz, &file_handle]() {
                return ctx->NewStringUTF(
                        getInboxApi(ctx, thiz)->closeFile(file_handle).c_str()
                );
            });
    if (ctx->ExceptionCheck()) {
        return nullptr;
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_simplito_kotlin_privmx_1endpoint_modules_inbox_InboxApi_subscribeFor(
        JNIEnv *env,
        jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_simplito_kotlin_privmx_1endpoint_modules_inbox_InboxApi_unsubscribeFrom(
        JNIEnv *env,
        jobject thiz,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_simplito_kotlin_privmx_1endpoint_modules_inbox_InboxApi_buildSubscriptionQuery(
        JNIEnv *env,
        jobject thiz,
        jlong event_type,
        jlong selector_type,
