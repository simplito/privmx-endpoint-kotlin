...
extern "C" JNIEXPORT void JNICALL
Java_com_simplito_kotlin_privmx_1endpoint_modules_kvdb_KvdbApi_subscribeForKvdbEvents(
        JNIEnv *env,
        jobject thiz
) {
    JniContextUtils ctx(env);
...
extern "C" JNIEXPORT void JNICALL
Java_com_simplito_kotlin_privmx_1endpoint_modules_kvdb_KvdbApi_unsubscribeFromKvdbEvents(
        JNIEnv *env,
        jobject thiz
) {
    JniContextUtils ctx(env);
...
extern "C" JNIEXPORT void JNICALL
Java_com_simplito_kotlin_privmx_1endpoint_modules_kvdb_KvdbApi_subscribeForEntryEvents(
        JNIEnv *env,
        jobject thiz,
        jstring kvdb_id
) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_simplito_kotlin_privmx_1endpoint_modules_kvdb_KvdbApi_unsubscribeFromEntryEvents(
        JNIEnv *env,
        jobject thiz,
        jstring kvdb_id
) {
