...
class ContainerPolicyBuilder : ContainerPolicyBuilderScope {
    ...
    override fun get(policyValue: ContainerPolicyValue): ContainerPolicyWithoutItemBuilderScope =
        apply { this.get = policyValue.value }

    override fun update(policyValue: ContainerPolicyValue): ContainerPolicyWithoutItemBuilderScope =
        apply { this.update = policyValue.value }

    override fun delete(policyValue: ContainerPolicyValue): ContainerPolicyWithoutItemBuilderScope =
        apply { this.delete = policyValue.value }

    override fun updatePolicy(policyValue: ContainerPolicyValue): ContainerPolicyWithoutItemBuilderScope =
        apply { this.updatePolicy = policyValue.value }

    override fun updaterCanBeRemovedFromManagers(policyValue: SpecialPolicyValue): ContainerPolicyWithoutItemBuilderScope =
        apply { this.updaterCanBeRemovedFromManagers = policyValue.value }

    override fun ownerCanBeRemovedFromManagers(policyValue: SpecialPolicyValue): ContainerPolicyWithoutItemBuilderScope =
        apply { this.ownerCanBeRemovedFromManagers = policyValue.value }

    override fun item(item: ItemPolicy): ContainerPolicyBuilderScope = apply { this.item = item }
