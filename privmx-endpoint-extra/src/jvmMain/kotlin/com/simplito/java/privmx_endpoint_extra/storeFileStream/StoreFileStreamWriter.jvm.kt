...
import com.simplito.java.privmx_endpoint_extra.storeFileStream.StoreFileStream.Controller
...
fun StoreFileStreamWriter.Companion.createFile(
    ...
    val chunk =
        ByteArray(com.simplito.java.privmx_endpoint_extra.storeFileStream.StoreFileStream.OPTIMAL_SEND_SIZE.toInt())
    var read: Int
...
fun StoreFileStreamWriter.Companion.updateFile(
    ...
    val chunk =
        ByteArray(OPTIMAL_SEND_SIZE.toInt())
    var read: Int
    while (true) {
        if (streamController != null && streamController.isStopped()) {
            return output.close()
