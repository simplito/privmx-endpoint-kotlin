 ...
 * @property groups                List of Groups granted access to the Store
 * @property staleGroups           IDs of the grantee Groups that have rotated past the epoch this Store's current
 * key was wrapped to; members of a stale Group cannot read content written under the current key until the Store
 * is re-keyed (see `StoreApi.rotateStoreKeys`)
 */
data class Store(
    val storeId: String,
