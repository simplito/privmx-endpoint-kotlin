...
constructor(
     ...
     */
    @Throws(PrivmxException::class, NativeException::class, IllegalStateException::class)
    fun deleteSearchIndex(indexId: String)
     ...
     */
    @Throws(PrivmxException::class, NativeException::class, IllegalStateException::class)
    fun getSearchIndex(indexId: String): SearchIndex
     ...
     */
    @Throws(PrivmxException::class, NativeException::class, IllegalStateException::class)
    fun openSearchIndex(indexId: String): Long
     ...
     */
    @Throws(PrivmxException::class, NativeException::class, IllegalStateException::class)
    fun closeSearchIndex(indexHandle: Long)
     ...
     */
    @Throws(PrivmxException::class, NativeException::class, IllegalStateException::class)
    fun beginTransaction(indexHandle: Long)
